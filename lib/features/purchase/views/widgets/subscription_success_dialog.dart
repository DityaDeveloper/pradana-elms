...
class SubscriptionSuccessDialog extends ConsumerStatefulWidget {
  const SubscriptionSuccessDialog({super.key, required this.planName});

  final String planName;

  @override
  ConsumerState<SubscriptionSuccessDialog> createState() =>
      _SubscriptionSuccessDialogState();
}

class _SubscriptionSuccessDialogState
    extends ConsumerState<SubscriptionSuccessDialog>
