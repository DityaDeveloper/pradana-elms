      ...
      child: Scaffold(
        ...
        body: Center(
          child: Container(
            ...
            child: ref.watch(examEndControllerProvider).whenOrNull(
                  data: (data) => Column(
                      ...
                      if (!isFromChapter)
                        CustomButton(
                          ...
                          onPressed: () {
                            ref
                                .refresh(
                                    selectedAnswerControllerProvider.notifier)
                                .stream;
                            ref
                                .refresh(
                                    questionHandlerControllerProvider.notifier)
                                .stream;
...
class _HeaderWidget extends StatelessWidget {
  final bool isFromChapter;
  const _HeaderWidget({required this.isFromChapter});
    ...
    return Column(
      children: [
        ...
        Consumer(builder: (context, ref, _) {
          final String? examTitle = ref.watch(selectedExamTitleProvider);
          return Text(
            examTitle ?? 'N/A',
            maxLines: 1,
    ...
    return AnimatedSwitcher(
      ...
      child: isBreakDown
          ? Container(
              ...
              decoration: ShapeDecoration(
                color: Color(context.isDarkMode ? 0xFF2E2E2E : 0xFFF0F8FF),
                shape: RoundedRectangleBorder(
                  borderRadius: BorderRadius.circular(24),
                ),
              ),
