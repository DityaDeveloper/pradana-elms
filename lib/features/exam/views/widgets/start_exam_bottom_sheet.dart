        ...
        Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Gap(12.h),
              _ExamHeaderWidget(examModel: exam),
              Gap(16.h),
              _SummeryWidget(examModel: exam),
              Gap(12.h),
              Align(
                ...
                return startExamRrovder.when(
                  data: (data) {
                    return CustomButton(
                      ...
                      onPressed: () => ref
                          .read(examStartControllerProvider.notifier)
                          .startExam(
                            examId: exam.id!,
                          )
                          .then((v) {
                        if (v) {
                          if (context.mounted) {
                            GoRouter.of(context)
                                .go(Routes.examScreen, extra: exam);
                          }
                        } else {
                          if (context.mounted) {
      ...
      child: Column(
        children: [
          ContentRowWidget(
            ...
            value: examModel.questionCount.toString(),
          ),
          Gap(12.h),
          ContentRowWidget(
            title: S.of(context).questionType,
            value: S.of(context).mcq,
          ),
          Gap(12.h),
          ContentRowWidget(
            title: S.of(context).totalMark,
            value: (examModel.questionCount ?? 0 * examModel.markPerQuestion!)
                .toString(),
          ),
          Gap(12.h),
          ContentRowWidget(
            title: S.of(context).examDuration,
            value: '${examModel.duration} ${S.of(context).minutes}',
          ),
        ],
      ),
    );
