        ...
        children: [
                        ...
                        : TextButton(
                            onPressed: () {
                              ref
                                  ...
                                  .then((val) async {
                                if (val == true) {
                                  await SocialAuth.logoutFromAllSocialMedia();
                                  Hive.box(AppConstants.authBox)
                                      .delete(AppConstants.authToken);
                                  ...
                                  appSettings.put(
                                      AppConstants.hasSubscription, false);
          ...
          Positioned(
            ...
            child: Container(
              ...
              child: SvgPicture.asset(Assets.svgs.logout, color: Colors.red),
            ),
          )
        ],
      ),
